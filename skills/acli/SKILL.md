...
**Announce at start:** "I'm using the acli skill to..."

## Defaults

- Typical ticket format: `XX-####`
- Typical branch name: `XX-####-ticket-title-slug`
- Always print the ticket URL after any ticket specific operation
...
3. If not authenticated, instruct user to run: `acli jira auth login --web`
4. Do NOT attempt to authenticate on behalf of the user
...
### Authentication
- Always use OAuth web-based authentication (`acli jira auth login --web`).
